...
newBody += '<ul><li>Columbia University is an Equal Opportunity/Affirmative Action Employer / Disability / Veteran</li></ul>;
newBody += '<ul><li>Columbia University is committed to the hiring of qualified local residents</li></ul><hr />';
